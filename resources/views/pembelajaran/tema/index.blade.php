...
@section('page-title')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tema</h1>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-weight-normal" aria-current="page">Tema</li>
        </ol>
    </div>
@endsection
@section('content')
    <ul class="list-group m-auto col-lg-10">
        ...
        @foreach($tema as $data)
            <li class="list-group-item d-flex justify-content-between">{{$data->tema}}
                <div>
                    ...
                    <div class="modal-body">
                        <form action="{{route('tema.update',['tema'=>$data->id])}}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="tema" class="col-sm-4 col-form-label">Tema</label>
                                <div class="col-sm-8">
                                    <input type="text" value="{{$data->tema}}" name="tema" class="form-control" id="tema">
                                </div>
                            </div>
                    </div>
                    <div class="modal-footer">
