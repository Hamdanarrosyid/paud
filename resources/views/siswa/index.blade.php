    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <h6 class="m-0 font-weight-bold text-primary"><a href="{{route('siswa.create')}}"><i class="fas fa-plus"></i> Tambah Data</a></h6>
            </div>
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTable">
                    ...
                    @foreach($siswa as $data)
                        <tr>
                            ...
                            <td><a href="{{route('siswa.show',['siswa'=>$data->id])}}" class="badge badge-info font-weight-light">Show & Edit</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
